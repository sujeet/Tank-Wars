...
void DecisionMaker::set_weightage_table(int strategy, int go_to_nearest_gold_weight, int attack_enemy_falcon_weight, int attack_enemy_tank_weight, int defend_your_falcon_weight)
{
...
void DecisionMaker::set_difficulty_table(int go_to_nearest_gold_difficulty, int attack_enemy_falcon_difficulty, int attack_enemy_tank_difficulty, int defend_your_falcon_difficulty)
{
...
Move DecisionMaker::go_to_nearest_gold_move()
{
